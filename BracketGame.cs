...
namespace BracketsApp
{
    public class BracketGame
    {
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<BracketPlayer>.Default.GetHashCode(p1);
            hashCode = hashCode * -1521134295 + EqualityComparer<BracketPlayer>.Default.GetHashCode(p2);
            return hashCode;
        }
    }
}
