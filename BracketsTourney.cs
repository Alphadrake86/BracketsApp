...
namespace BracketsApp
{
    public class BracketsTourney
    {
        ...
        public void AddPlayersFromFile(string[] strings)
        {
            ...
            {
                throw new BracketsException("Invalid file format");
            }
        }
        ...
        public void GenerateTournament()
        {
            ...
            if (GetEmptySlots() > 0)
            {
                throw new BracketsException($"This file needs {GetEmptySlots()} more players");
            }
            ...
            do
            {
                ...
                if (failing)
                {
                    ...
                    {
                        throw new BracketsException("Too many iterations. Possible Impossible situation.");
                    }
